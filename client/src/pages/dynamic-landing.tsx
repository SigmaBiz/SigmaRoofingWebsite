    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* FAQ Link */}
          <div className="bg-emerald-600 text-white rounded-lg p-8 text-center mb-8">
            <h2 className="text-2xl font-bold mb-4">Have Questions About Storm Damage & Insurance Claims?</h2>
            <p className="text-lg mb-6">Get answers to common questions about the roof repair process, insurance claims, and what to expect.</p>
            <a 
              href="/#faq" 
